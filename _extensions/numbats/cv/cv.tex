...
$endif$
\author{
  $if(phone)$$phone$$endif$\quad
  $if(email)$$email$$endif$\quad
  $if(www)$$www$$endif$\quad
}
...
\colorbox{gray!75}{\parbox[t]{\dimexpr\textwidth-2\fboxsep-\secnumberwd}{\centerline{\textcolor{white}{#1}}}}%
}
...
\pretitle{\vspace*{-3cm}\LARGE\bfseries\begin{center}}
